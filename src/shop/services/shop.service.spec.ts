...
describe('ShopService', () => {
    ...
    beforeEach(async () => {
        ...
        shopsNotificationsGateway = module.get<ShopsNotificationsGateway>(ShopsNotificationsGateway);
    ...
    describe('findAllShops', () => {
        ...
        it('should return an array of shops without cache', async () => {
            ...
            jest.spyOn(shopRepository, 'createQueryBuilder').mockReturnValue(mockQueryBuilder as any)

            jest.spyOn(shopMapperMock, 'mapEntityToResponseDto').mockReturnValue(shopDto)
        ...
        it('should return an array of shops with cache', async () => {
            ...
            jest.spyOn(cacheManager, 'get').mockResolvedValue(Promise.resolve(testShop))
            jest.spyOn(cacheManager, 'set').mockResolvedValue()

            const result: any = await service.findAllShops(query);

            console.log(result.data[0].books)
    ...
    describe('findOne', () => {
        ...
        it('should return not found shop', async () => {
            ...
            jest.spyOn(cacheManager, 'get').mockResolvedValue(Promise.resolve(null))
            jest.spyOn(cacheManager, 'set').mockResolvedValue()
            const result: any = service.findOne('7f1e1546-79e5-49d5-9b58-dc353ae82f97');

            await expect(result).rejects.toThrowError(`Shop con ID: ${shop.id} no encontrada`);
        })
    })
    ...
    describe('create', () => {
        ...
        it('should return error shop already exists', async () => {
            ...
            await expect(result).rejects.toThrowError(`La Shop con el nombre ${shop.name} ya existe`);
        })
    })
    ...
    describe('update', () => {
        ...
        it('should return error shop already exists', async () => {
            ...
            const result: any = service.update(shop.id, {...updatedShop, name: 'Librería Pepito 2'});

            await expect(result).rejects.toThrowError(`Shop con nombre: Librería Pepito 2 ya existe`);
        })
    })
    ...
    describe('getByName', () => {
        ...
        it('should return a shop', async () => {
            ...
            jest.spyOn(shopRepository, 'createQueryBuilder').mockReturnValue(queryBuilder as any)
            jest.spyOn(shopMapperMock, 'mapEntityToResponseDto').mockReturnValue(shopDto);
    ...
    describe('getBooksByShopName', () => {
        ...
        it('should return null', async () => {
            ...
            await expect(result).rejects.toThrowError(`Shop con nombre: ${shop.name} no encontrada`);
        })
    })
    ...
    describe('addBookToShop', () => {
        ...
        it('should return error book not found', async () => {
            ...
            await expect(result).rejects.toThrowError(`Book con ID: ${book.id} no encontrado`);
        })
    })
    ...
    describe('removeBookFromShop', () => {
        ...
        it('should remove a book from a shop', async () => {
            ...
            jest.spyOn(cacheManager, 'get').mockResolvedValue(Promise.resolve(null))
            jest.spyOn(cacheManager, 'set').mockResolvedValue()
            jest.spyOn(shopMapperMock, 'mapEntityToResponseDto').mockReturnValue({...shopDto, booksId: []});
    ...
    describe('addClientToShop', () => {
        ...
        it('should add a client to a shop', async () => {
            ...
            jest.spyOn(cacheManager, 'get').mockResolvedValue(Promise.resolve(null))
            jest.spyOn(cacheManager, 'set').mockResolvedValue()
            jest.spyOn(shopMapperMock, 'mapEntityToResponseDto').mockReturnValue({...shopDto, clientsId: [client.id]});
        ...
        it('should return error client not found', async () => {
            ...
            await expect(result).rejects.toThrowError(`Client con ID: ${client.id} no encontrado`);
    ...
    describe('removeClientFromShop', () => {
        ...
        it('should remove a client from a shop', async () => {
            ...
            jest.spyOn(cacheManager, 'get').mockResolvedValue(Promise.resolve(null))
            jest.spyOn(cacheManager, 'set').mockResolvedValue()
            jest.spyOn(shopMapperMock, 'mapEntityToResponseDto').mockReturnValue({...shopDto, clientsId: []});
